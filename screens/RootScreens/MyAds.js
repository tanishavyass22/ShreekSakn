    ...
    <View style={styles.container}>
      <ImageBackground source={require("../../assets/images/Frame.png")} style={styles.backgroundImage}>
        <View style={styles.smallView}>
          ...
          <Text style={styles.text}>My Adds</Text>
        </View>
      </ImageBackground>
      <View style={styles.tabContainer}>
        <TouchableOpacity onPress={() => setActiveTab("rooms")}>
          <Text style={[styles.tab, activeTab === "rooms" && styles.activeTab]}>Rooms</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setActiveTab("roommates")}>
          <Text style={[styles.tab, activeTab === "roommates" && styles.activeTab]}>Roommate</Text>
        </TouchableOpacity>
      </View>
      {activeTab === "rooms" ? (
        ...
        <View style={styles.redSquare}>
          <Text style={styles.redSquareText}>No Roommates Available</Text>
        </View>
      )}
    </View>
  );
