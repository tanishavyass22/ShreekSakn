...
const App = () => {
  ...
  const renderItem = ({item}) => (
    <TouchableOpacity
    onPress={()=>{
      navigation.navigate("RootStack", { screen: "MyAd" })
    }} 
    style={[styles.Newcard, { borderColor: item.id === visibleItem ? '#1C5298' : 'transparent', borderWidth: 2 }]}>
  ...
  const renderRoommate = ({item}) => (
    <TouchableOpacity 
    onPress={()=>{
      navigation.navigate("RootStack", { screen: "RoomateAd" })
    }}
   ...
   const VideoCard = ({item}) => (
    <TouchableOpacity 
    style={{width:282,backgroundColor:'white', elevation:1, shadowColor: '#00000050', marginLeft:20, borderRadius:14,marginBottom:6}}>
      <Image source={item.image} style={styles.Vimage} />
      <TouchableOpacity style={styles.VplayButton}>
           <Image source={require('../../assets/images/Vbutton.png')}
  ...
  return (
    ...
    <View style={styles.container}>
      <ImageBackground
        ...
        <View style={styles.row}>
          <View style={styles.logoContainer}>
            <Image
              source={require('../../assets/images/png_logo.png')}
              style={styles.image}
            />
          </View>
      ...
      <View style={styles.overlayBox}>
        <View style={styles.overlayRow}>
          <TouchableOpacity onPress={()=>{
           navigation.navigate("RootStack", { screen: "SeacrchScreen" })
          }}>
          <Image
          ...
          <TouchableOpacity  onPress={()=>{
            navigation.navigate("RootStack", { screen: "SearchRoomate" })
          }}>
          <Image
      ...
      <View style={styles.underFlatlist}>
        <Text style={styles.nearBy}>Nearby Roommates</Text>
        <Text style={styles.seeAll}>See All</Text>
      </View>
      <FlatList
        data={roommates}
      ...
      />
      <View style={{width:500, borderWidth:1, borderColor:'#00000012', marginTop:40}}></View>
      <ImageBackground
      source={require('../../assets/images/homeBottombg.png')}
      style={{ padding: 15 }}
      resizeMode="cover"
    >
      <Text style={{ color: '#1F1F1F', fontSize: 18, fontWeight: '600', marginBottom: 6 }}>
        How we are doing
      </Text>
      <Text style={{ color: '#6C757D', fontSize: 14,lineHeight:22}}>
