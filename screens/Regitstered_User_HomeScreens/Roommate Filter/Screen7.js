...
const App = () => {
  ...
  const [RoommateLanguage, setRoommateLanguage] = useState('');
  ...
  const options = ["Both", "English", "Arabic"];
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View>
            ...
            <Text style={styles.selectedText}>{RoommateLanguage}</Text>
          </View>
        </View>
        ...
        {options.map(option => (
          <View key={option} style={styles.optionRow}>
            ...
            <TouchableOpacity onPress={() => setRoommateLanguage(option)}>
              {RoommateLanguage === option ? <RadioChecked /> : <RadioUnchecked />}
            </TouchableOpacity>
          </View>
        ))}
      </View>
