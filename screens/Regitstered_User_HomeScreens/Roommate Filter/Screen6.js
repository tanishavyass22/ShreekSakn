...
const App = () => {
  ...
  const [RoommateSmoking, setRoommateSmoking] = useState('');
  ...
  const options = ["No Preference", "Smoker", "Non-Smoker"];
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View>
            ...
            <Text style={styles.selectedText}>{RoommateSmoking}</Text>
          </View>
        </View>
        ...
        {options.map(option => (
          <View key={option} style={styles.optionRow}>
            ...
            <TouchableOpacity onPress={() => setRoommateSmoking(option)}>
              {RoommateSmoking === option ? <RadioChecked /> : <RadioUnchecked />}
            </TouchableOpacity>
          </View>
        ))}
      </View>
